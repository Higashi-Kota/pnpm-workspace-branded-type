...
export default defineConfig({
  ...
  build: {
    lib: {
      entry: {
        'inventory/domains/index': resolve(
          __dirname,
          'src/inventory/domains/index.ts'
        ),
        'order/domains/index': resolve(__dirname, 'src/order/domains/index.ts'),
      },
      // name: '@ecommerce/core', // 複数エントリでは不要
